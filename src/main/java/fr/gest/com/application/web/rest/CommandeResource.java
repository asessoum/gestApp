...
/**
 * REST controller for managing {@link fr.gest.com.application.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
public class CommandeResource {
    ...
    public ResponseEntity<List<CommandeDTO>> getAllCommandes(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

...
/**
 * REST controller for managing {@link fr.gest.com.application.domain.MouvementStock}.
 */
@RestController
@RequestMapping("/api")
public class MouvementStockResource {
    ...
    public List<MouvementStockDTO> getAllMouvementStocks(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
